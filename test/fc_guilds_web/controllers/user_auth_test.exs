defmodule FcGuildsWeb.UserAuthTest do
  use FcGuildsWeb.ConnCase, async: true

  alias FcGuilds.Accounts
  alias FcGuildsWeb.UserAuth
  import FcGuilds.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FcGuildsWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FcGuildsWeb.Endpoint.subscribe(live_socket_id)
